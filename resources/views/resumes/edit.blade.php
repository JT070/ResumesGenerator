    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- el $reusme->id lo rescibe del Controlador de EDIT -->
                    <form method="POST" action="{{ route('resumes.update', $resume->id) }}" enctype="multipart/form-data">
                        @csrf
                        <!-- HTML solo procesa GET y POST, pero así especificamos a Laravel que esto es un PUT -->
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                name="name" 
                                value="{{ old('name') ?? $resume->user->name }}" required 
                                autocomplete="name" 
                                autofocus
                            >
                            @error('name')
